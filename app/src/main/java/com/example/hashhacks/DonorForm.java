...
import static com.example.hashhacks.MainActivity2.database;
...
public class DonorForm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] citis = new String[]{"Delhi","Noida", "Meerut", "Bangalore","Mumbai", "Pune", "Agra", "Modinagar"};
        ...
        Save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String lat = MainActivity2.lat.toString();
                String lng = MainActivity2.lng.toString();
