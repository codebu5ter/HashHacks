...
public class Maps2 extends AppCompatActivity implements Constants, OnMapReadyCallback {
  ...
  /*  @Override
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        PlaceAutocompleteFragment autocompleteFragment = (PlaceAutocompleteFragment)
                Maps2.this.getFragmentManager().findFragmentById(R.id.place_autocomplete_fragment);
        ...
        autocompleteFragment = (PlaceAutocompleteFragment)
                Maps2.this.getFragmentManager().findFragmentById(R.id.place_autocomplete_fragment2);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (Splace == null) {
                    Toast.makeText(Maps2.this, "Enter source", Toast.LENGTH_SHORT).show();
                } else if (Dplace == null) {
                    Toast.makeText(Maps2.this, "Enter destination", Toast.LENGTH_SHORT).show();
                } else {
                    getDirections();
                }
            }
        ...
        this.mapFragment = (com.google.android.gms.maps.MapFragment) Maps2.this.getFragmentManager()
